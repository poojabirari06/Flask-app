...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://admin:password@terraform-20240304090805374800000001.c1asyqik8ajm.us-east-1.rds.amazonaws.com/terraform_db'
db = SQLAlchemy(app)
